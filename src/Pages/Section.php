...
class Section extends Page
{
    ...
    {
        #Allow `blob:`
        @\header('content-security-policy: upgrade-insecure-requests; default-src \'self\'; child-src \'self\'; connect-src \'self\'; font-src \'self\'; frame-src \'self\'; img-src \'self\' blob:; manifest-src \'self\'; media-src \'self\'; object-src \'none\'; script-src \'report-sample\' \'self\'; script-src-elem \'report-sample\' \'self\' \'sha256-UlpVu12T/vnn/lWMW2AVbF/b4RaNq0hvdVE3BzJFsL8=\'; script-src-attr \'none\'; style-src \'report-sample\' \'self\'; style-src-elem \'report-sample\' \'self\'; style-src-attr \'none\'; worker-src \'self\'; base-uri \'self\'; form-action \'self\'; frame-ancestors \'self\';');
        #Sanitize ID
        $id = $path[0] ?? 'top';
        if ($id !== 'top' && (int)$id < 1) {
        ...
        $output_array = new \Simbiat\Talks\Entities\Section($id)->getArray();
